  ...
  return (
    <>
      ...
      <div
        ...
        id="contatti"
      >
        <div className="text-white lg:text-lg text-md uppercase cursor-pointer mb-12">
          <ScrollLink to="home">
        ...
        <div className="text-white mb-12">
          <h2 className=" md:text-lg text-md mb-2 uppercase">Contatti</h2>
          <h3 className=" mb-2">Email : falegnameri@gmail.com</h3>
          <h3>Telefono : 333/555 555 555</h3>
        </div>
        <div className="text-white text-center">
          <h2 className="md:text-lg text-md mb-2 uppercase">
